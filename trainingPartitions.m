...
% We got this code from MatLab example: Sequence-to-One Regression Using Deep Learning
% it randomly asigns an index based off the input parameter to output arrays
% by the percent split indicated in the splits input matrix
